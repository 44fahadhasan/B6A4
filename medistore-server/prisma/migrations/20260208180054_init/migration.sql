...
-- CreateEnum
CREATE TYPE "PharmacieOrderStatus" AS ENUM ('pending', 'confirmed', 'shipped', 'delivered', 'canceled');
...
-- CreateTable
CREATE TABLE "pharmacie-orders" (
    "id" TEXT NOT NULL,
    "subtotal" DOUBLE PRECISION NOT NULL,
    "commission" DOUBLE PRECISION,
    "payoutAmount" DOUBLE PRECISION,
    "status" "PharmacieOrderStatus" NOT NULL DEFAULT 'pending',
    "confirmedAt" TIMESTAMP(3),
    "shippedAt" TIMESTAMP(3),
    "deliveredAt" TIMESTAMP(3),
    "canceledAt" TIMESTAMP(3),
    ...
    CONSTRAINT "pharmacie-orders_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "order_items" (
    ...
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "medicineId" TEXT NOT NULL,
    "pharmacieOrderId" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "pharmacie-orders_pharmacieId_idx" ON "pharmacie-orders"("pharmacieId");

-- CreateIndex
CREATE INDEX "pharmacie-orders_status_idx" ON "pharmacie-orders"("status");

-- CreateIndex
CREATE UNIQUE INDEX "pharmacie-orders_orderId_pharmacieId_key" ON "pharmacie-orders"("orderId", "pharmacieId");

-- CreateIndex
CREATE INDEX "order_items_pharmacieOrderId_idx" ON "order_items"("pharmacieOrderId");
...
-- CreateIndex
CREATE INDEX "payments_pharmacieOrderId_idx" ON "payments"("pharmacieOrderId");

-- CreateIndex
CREATE INDEX "reviews_userId_idx" ON "reviews"("userId");

-- CreateIndex
CREATE INDEX "reviews_pharmacieOrderId_idx" ON "reviews"("pharmacieOrderId");
...
-- AddForeignKey
ALTER TABLE "pharmacie-orders" ADD CONSTRAINT "pharmacie-orders_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pharmacie-orders" ADD CONSTRAINT "pharmacie-orders_pharmacieId_fkey" FOREIGN KEY ("pharmacieId") REFERENCES "pharmacies"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "order_items" ADD CONSTRAINT "order_items_pharmacieOrderId_fkey" FOREIGN KEY ("pharmacieOrderId") REFERENCES "pharmacie-orders"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "payments" ADD CONSTRAINT "payments_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "payments" ADD CONSTRAINT "payments_pharmacieOrderId_fkey" FOREIGN KEY ("pharmacieOrderId") REFERENCES "pharmacie-orders"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "reviews" ADD CONSTRAINT "reviews_pharmacieOrderId_fkey" FOREIGN KEY ("pharmacieOrderId") REFERENCES "pharmacie-orders"("id") ON DELETE CASCADE ON UPDATE CASCADE;
