import SellerSingupForm from "@/components/pages/public/auth/seller-singup/seller-sinngup-form";
...
export default function SellerSingupPage() {
  return (
    <section className="relative md:min-h-screen lg:grid lg:grid-cols-2">
      <div className="relative hidden h-full flex-col border-r bg-secondary p-10 lg:flex dark:bg-secondary/20">
        ...
        <div className="z-10 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-xl">
              &ldquo;Medistore helps us run our pharmacy more efficiently — from
              managing products and stock levels to processing orders and
              tracking sales, everything is handled in one reliable
              platform.&rdquo;
            </p>
