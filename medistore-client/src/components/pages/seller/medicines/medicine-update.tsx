...
import {
  medicineFormSchema,
  TMedicine,
} from "@/form-schemas/medicine-form.schema";
...
export default function UpdateMedicine({
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      const id = toast.loading("Update medicine, please wait...");

      try {
        const { success, message } = await updateMedicine({
          id: data.id,
          payload: value,
        });
  ...
  return (
    <FormModal
      ...
      triggerLabel="Edit Medicine"
      submitLabel="Update Medicine"
      modalTitle="Update Medicine Record"
      modalDescription="Modify the selected medicine to ensure correct product data and compliance."
      formComp={
        <form
          id={formId}
          onSubmit={(e) => {
