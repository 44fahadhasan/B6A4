...
import { createPharmacie } from "@/actions/pharmacies.action";
...
import { pharmacieFormSchema } from "@/form-schemas/pharmacie-form.schema";
import { useForm } from "@tanstack/react-form";
import { toast } from "sonner";

export default function AddPharmacy() {
  const formId = "pharmacie-create";
  const form = useForm({
    defaultValues: {
      name: "",
      slug: "",
    ...
    onSubmit: async ({ value }) => {
      const id = toast.loading("Create pharmacie, please wait...");
  ...
  return (
    <FormModal
      ...
      triggerLabel="Add Pharmacy"
      submitLabel="Create Pharmacy"
      modalTitle="Add New Pharmacy"
      modalDescription="Register a new pharmacy to your network so it can manage inventory, receive orders, and serve customers."
      formComp={
        <form
          id={formId}
          onSubmit={(e) => {
