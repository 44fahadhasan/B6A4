...
const APP_EMAIL = "44fahadhasan@gmail.com";
const APP_PHONE = "+880 1568-335944";
const APP_PHONE_2 = "+880 1322-632021";

export function Contact() {
  const socialLinks = [
    {
      icon: GithubIcon,
      href: "https://github.com/44fahadhasan",
      label: "GitHub",
    },
    {
      icon: XIcon,
      href: "https://www.linkedin.com/in/44fahadhasan",
      label: "Twitter",
    },
  ];
    ...
    <div className="mx-auto h-full min-h-screen max-w-5xl lg:border-x">
      <div className="flex grow flex-col justify-center px-4 py-18 md:items-center">
        ...
        <p className="mb-5 text-base text-muted-foreground">
          Contact the support team at medistore platform.
        </p>
      </div>
      <BorderSeparator />
      <div className="grid md:grid-cols-3">
        ...
        >
          <span className="font-medium font-mono text-sm tracking-wide">
            Office # 100, 101 Second Floor Kohinoor 1, Bogura, Bangladesh
          </span>
        </Box>
        <Box
