...
export interface IMedicineQueryParams extends IPaginationOptions {
  search?: string;
  category?: string;
  featured?: boolean;
  minPrice?: number;
...
export const medicineService = {
  getFeatureMedicines: async function () {
    try {
      const res = await fetch(`${API_URL}/medicines?featured=true`, {
        method: "GET",
        next: {
          tags: ["medicines"],
        },
  ...
  getMedicines: async function (params?: IMedicineQueryParams) {
    try {
